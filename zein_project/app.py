            ...
            if sel_student == "-- All Students --":
                ...
                if st.button("Save Attendance List"):
                    ...
                    for _, r in res_att.iterrows():
                        attendance.loc[len(attendance)] = [r.Student, sel_cls, sel_term, min(r['Days Present'], MAX_SCHOOL_DAYS)]
                    save(attendance, ATTENDANCE_FILE); st.success("Saved!"); st.rerun()
            else:
                ...
                if st.button(f"Update Attendance for {sel_student}"):
                    ...
                    save(attendance, ATTENDANCE_FILE); st.success("Updated!"); st.rerun()
...
# =========================
    ...
    if m.empty:
        ...
        recorded_terms = len(att_df) if not att_df.empty else 1
        ...
        with col_charts_1:
            ...
            # Explicitly using Bar Chart for trends
        ...
        st.caption(f"Intervention Required for red items. Attendance based on {MAX_SCHOOL_DAYS}-day terms.")
